...
import { getPayPeriodRange, loadCompanyPeriodSettings, toDateStr } from '@/lib/employee-period'
        ...
        <Card>
          <form onSubmit={handleSaveHomePeriod} className="space-y-4">
            ...
            {homePeriodType !== 'monthly' && (
              <div>
                ...
                <p className="text-xs text-tertiary mt-1">
                  {periodAnchor
                    ? (() => {
                        const r = getPayPeriodRange({ periodType: homePeriodType, anchor: periodAnchor, lag: 0, paid: paidPeriods })
                        return `Pay period to pay now: ${toDateStr(r.start)} → ${toDateStr(r.end)}`
                      })()
            ...
            <p className="text-xs text-tertiary">
              Employees&apos; Home, Hours and Pay (and Payroll&apos;s &quot;Pay Period (to pay)&quot;) show the oldest
              period that has ended and hasn&apos;t been marked as paid yet. After you tap <strong>Mark as Paid</strong> in
              Payroll, everyone moves on to the next period automatically.
            </p>
